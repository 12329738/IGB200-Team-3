...
namespace JuiceBox
{
    internal sealed class EffectNode : Node
    {
        ...
        public const float NodeW = FilmStripElement.NodeSize - JBGraphView.NodeMargin * 2f;
        ...
        private void BuildCloseButton()
        {
            ...
            closeBtn.style.color = _theme.NodeBtn;
            ...
            closeBtn.RegisterCallback<MouseLeaveEvent>(_ => closeBtn.style.color = _theme.NodeBtn);
            Add(closeBtn);
        }
        ...
        private void BuildHookBadges(IEffect effect, float lp, float y, float fw, System.Type valueType)
        {
            ...
            {
                if (hideKick && BadgeSlotNames[i] == "SetStartingVelocity") continue;
            ...
            if (isShake)
                AddOvertimeBadge(effect, lp, y, slotW, visibleCount - 1);
        }
