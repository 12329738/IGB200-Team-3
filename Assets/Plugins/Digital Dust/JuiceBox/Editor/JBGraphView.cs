...
// ==============================================================================
//  JBGraphView: Core graph view for the sequence editor. Manages strips, nodes, and edges.
// ==============================================================================
namespace JuiceBox
{
    internal sealed partial class JBGraphView : GraphView
    {
        ...
        public JBGraphView(SequenceEditorWindow window)
        {
            _window = window;
        ...
        {
            private readonly JBGraphView _gv;
            ...
            public EdgeDropSpawnListener(JBGraphView gv)
            {
                _gv = gv;
